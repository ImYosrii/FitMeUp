    ...
    return (
        <div className='footer-container' id='contact'>
            ...
            <div className='footer-links-container'>
                ...
                <a href='https://yosri-swidan.netlify.app/' target='_blank' style={{color:'rgb(210, 2, 2)'}} >Y.S</a>
            </div>
            <p style={{marginTop: '3em', color:'gray'}}><AiFillCopyrightCircle />2024 Yosri Swidan</p>
        </div>
    )
}